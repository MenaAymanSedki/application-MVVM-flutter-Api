...
@JsonSerializable()
class ForgotPasswordResponses extends BaseResponse{
  @JsonKey(name:'support')
  String?support;

  ForgotPasswordResponses(this.support);

  // to Json

  Map<String,dynamic> toJson() => _$ForgotPasswordResponsesToJson(this);

  // from Json 

  factory ForgotPasswordResponses.fromJson(Map<String,dynamic> json) => _$ForgotPasswordResponsesFromJson(json);
}
