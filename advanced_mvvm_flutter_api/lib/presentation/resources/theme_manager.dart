...
ThemeData getApplicationTheme() {
  return ThemeData(
      ...
      // text theme
        textTheme: TextTheme(
         headlineLarge: getSemiBoldStyle(color: ColorManager.darkGrey,fontSize: FontSize.s12),
         titleMedium: getMediumStyle(color: ColorManager.lightGrey,fontSize: FontSize.s12),
